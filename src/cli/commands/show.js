...
export function setFlags(commander: Object) {
  commander.description('Shows explicit package dependencies.');
  commander.usage('show [package...]');
}
...
export async function run(config: Config, reporter: Reporter, flags: Object, args: Array<string>): Promise<number> {
  ...
  let deps = await PackageRequest.getExplicitDependencies(lockfile, install, config, reporter);
